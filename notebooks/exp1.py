...
mlflow.set_tracking_uri("https://dagshub.com/Fcozer/mlops_project.mlflow")  # URL to track the experiment

# Load the dataset from a CSV file
data = pd.read_csv("/Users/furkanozer/Desktop/water_potability.csv")
